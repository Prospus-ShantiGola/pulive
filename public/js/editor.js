...
$(document).ready(function(e) {
	...
	$("body").on("click",".msg-statement-wrap .edtHyperLink",function(){
	...
	$("body").on("click",".edt .edtHyperLink",function(event){
		var getLink = $(this).attr("data-link");
		...
		var getPos = $(this).position();
		if($(this).closest('.more-txt-span').hasClass("clearfix")){
...
//		highlightText(tagStatus);
		...
		if(getCurrentPosition.className.indexOf("edtParagraph")>-1)
		{
			...
			if($keycode===13){
				if(isScrolledIntoView($(getCurrentPosition))==false){
