...
DEFINE('SOCKET_CHAT_URL', "ws://" . $http_host . ":9004/course-dialogue-server.php");
DEFINE('EDITOR', $proto . $http_host . '/public/js/edt-worker.js');
DEFINE('SOCKET_HOST_NAME', 'http://www.prospus.com/qa/');
DEFINE('JS_ROUTE_PATH', 2);
...
DEFINE('ABS_API_URL', 'http://puqacdn.s3.amazonaws.com/');
DEFINE('AWS_CDN_URL', 'http://d2p1qmy4uhnjr3.cloudfront.net/');
DEFINE('PU_CDN_URL', 'http://d351pgenwsh12w.cloudfront.net/');
...
/* --------------------------------
  ...
  --------------------------------- */
DEFINE('IOS_PEM_FILE', 'pushcert_qa.pem');
...
DEFINE('SYSTEM_MEMBER_NODE_ID', 2195081);
...
DEFINE('GROUP_SUBSCRIPTION_CLASS_NID', 2194994);
...
DEFINE('SUBS_GROUP_ACT_ROLE_CLASS_NID', 2195032);
