...
DEFINE('EDITOR', $proto . $http_host . '/public/js/edt-worker.js');
DEFINE('SOCKET_HOST_NAME', 'http://www.prospus.com/dev/');
DEFINE('JS_ROUTE_PATH', 1);
...
DEFINE('EMAIL_CLASS_ID', 940);
DEFINE('EMAIL_SETTING_CLASS_ID', 941);
DEFINE('EMAIL_SETTING_TYPE_PROPERTY_ID', 13303);
DEFINE('EMAIL_SETTING_ACTOR_PROPERTY_ID', 13305);
DEFINE('EMAIL_SETTING_ACTOR_EMAIL_PROPERTY_ID', 13306);
DEFINE('EMAIL_SETTING_ACTOR_PASSWORD_PROPERTY_ID', 13307);
DEFINE('EMAIL_FROMADDRESS_PROPERTY_ID', 13285);
DEFINE('EMAIL_TOADDRESS_PROPERTY_ID', 13286);
DEFINE('EMAIL_DATE_PROPERTY_ID', 13287);
DEFINE('EMAIL_SUBJECT_PROPERTY_ID', 13289);
DEFINE('EMAIL_HTMLMSG_PROPERTY_ID', 13290);
DEFINE('EMAIL_PLAINMSG_PROPERTY_ID', 13291);
DEFINE('EMAIL_ATTACHMENT_PROPERTY_ID', 13292);
DEFINE('EMAIL_UID_PROPERTY_ID', 13293);
DEFINE('EMAIL_RECENT_PROPERTY_ID', 13294);
DEFINE('EMAIL_FLAGGED_PROPERTY_ID', 13295);
DEFINE('EMAIL_ANSWERED_PROPERTY_ID', 13296);
DEFINE('EMAIL_DELETED_PROPERTY_ID', 13297);
DEFINE('EMAIL_SEEN_PROPERTY_ID', 13298);
DEFINE('EMAIL_DRAFT_PROPERTY_ID', 13299);
DEFINE('EMAIL_MSGID_PROPERTY_ID', 13300);
DEFINE('EMAIL_MSG_REFERENCE_PROPERTY_ID', 13301);
DEFINE('EMAIL_SETTING_STATIC_ID', 2357725);
...
DEFINE('ABS_API_URL', 'http://pudevbucket.s3.amazonaws.com/');
DEFINE('AWS_CDN_URL', 'http://d32hf4gnye7i2l.cloudfront.net/');
DEFINE('PU_CDN_URL', BASE_URL); //'http://d3j04810ddyql4.cloudfront.net/');
...
/* --------------------------------
  ...
  --------------------------------- */
DEFINE('IOS_PEM_FILE', 'pushcert_dev.pem');
