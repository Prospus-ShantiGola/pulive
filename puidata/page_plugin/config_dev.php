...
$host       = 'http://dev.pu.prospus.com';
$doc_root   = $_SERVER['DOCUMENT_ROOT'];
DEFINE('PAGE_PLUGIN_CONFIG_FILE', 'config_dev.php');
DEFINE('BASE_URL_API', $host.'/puidata/page_plugin/');
DEFINE('WEB_API_URL', $host.'/pui/');
DEFINE('UPLOAD_URL_API', 'http://pudevbucket.s3.amazonaws.com/public/nodeZimg/');
DEFINE('ABS_API_URL', 'http://d32hf4gnye7i2l.cloudfront.net'); //http://pudevbucket.s3.amazonaws.com/
...
DEFINE('FILE_DOMAIN', 'dev.pu.prospus.com');
...
/* --------------------------------
  | Individual Settings            |
  --------------------------------- */
DEFINE('INDIVIDUAL_DEVICE_ID', 9149);
