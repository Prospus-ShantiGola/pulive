...
DEFINE('PAGE_PLUGIN_CONFIG_FILE', 'config_loc.php');
DEFINE('BASE_URL_API', $host.'/puidata/page_plugin/');
DEFINE('WEB_API_URL', $host.'/pui/');
DEFINE('UPLOAD_URL_API', 'http://localdevbucket.s3.amazonaws.com/public/nodeZimg/');
...
DEFINE('FILE_DOMAIN', 'localhost/pu');
