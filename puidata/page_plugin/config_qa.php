...
DEFINE('PAGE_PLUGIN_CONFIG_FILE', 'config_qa.php');
DEFINE('BASE_URL_API', $host.'/puidata/page_plugin/');
DEFINE('WEB_API_URL', $host.'/pui/');
DEFINE('UPLOAD_URL_API', 'http://puqacdn.s3.amazonaws.com/public/nodeZimg/');
...
DEFINE('FILE_DOMAIN', 'qa.pu.prospus.com');
DEFINE('APPONE_API_URL', 'https://demo.external.appone.net');
...
/* --------------------------------
  | Individual Settings            |
  --------------------------------- */
DEFINE('INDIVIDUAL_DEVICE_ID', 9141);
...
DEFINE('INDIVIDUAL_DEVICE_TOKEN', 9141);

/* --------------------------------
  | Individual History            |
  --------------------------------- */
DEFINE('INDIVIDUAL_HISTORY_CLASS_ID', 867);
DEFINE('INDIVIDUAL_ACTORID_PROP_ID', 9145);
DEFINE('INDIVIDUAL_TIMESTAMP_PROP_ID', 9146);
DEFINE('INDIVIDUAL_STATUS_PROP_ID', 9147);
